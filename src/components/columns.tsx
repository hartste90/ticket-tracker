    ...
    cell: ({ getValue, row, column, table }) => {
      ...
      return (
        <div className="space-y-0 flex">
          ...
          <div
            id="actions"
            className=" flex flex-col grow items-end justify-center "
          >
            <Popover>
              <PopoverTrigger>
                <div className="w-max h-max p-2  bg-emerald-500 text-white text-sm rounded-md hover:bg-emerald-600">
                  Make Offer
                </div>
              </PopoverTrigger>
              <PopoverContent>
            ...
            <div className=" mt-3 ">
              <button
                className="flex items-center content-center bg-red-200 self-center underline text-rose-400 rounded-md p-2 hover:bg-rose-100 transition-all"
                onClick={removeListing}
              >
                Mark Sold
              </button>
